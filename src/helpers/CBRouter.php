...
class CBRouter
{
    ...
    private static function apiRoute() {
        // API Authentication
        Route::group(['middleware'=> array_merge(['api'], config('crudbooster.MIDDLEWARE.apiRoute')),'namespace'=>static::$cb_namespace], function() {
        ...
        Route::group(['middleware' => array_merge(['api', CBAuthAPI::class], config('crudbooster.MIDDLEWARE.apiRoute')), 'namespace' => 'App\Http\Controllers'], function () {
            Route::withoutMiddleware(config('crudbooster.WITHOUT_MIDDLEWARE.apiRoute'))->group(function () {
    ...
    private static function uploadRoute() {
        Route::group(['middleware' => array_merge(['web'], config('crudbooster.MIDDLEWARE.uploadRoute')), 'namespace' => static::$cb_namespace], function () {
    ...
    private static function authRoute() {
        Route::group(['middleware' => array_merge(['web'], config('crudbooster.MIDDLEWARE.authRoute')), 'prefix' => config('crudbooster.ADMIN_PATH'), 'namespace' => static::$cb_namespace], function () {
    ...
    private static function userControllerRoute() {
        Route::group([
            'middleware' => array_merge(['web', '\crocodicstudio\crudbooster\middlewares\CBBackend'], config('crudbooster.MIDDLEWARE.userControllerRoute')),
